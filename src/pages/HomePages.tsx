...
export default function HomePage() {
  return (
    <main className=" mx- my-3 flex justify-between">
      <div className="mx-3  w-full">
        <div className="flex justify-between border border-black rounded-2xl p-3 items-center">
          <div>
        ...
        <div>
          ...
          <Button className="w-full cursor-pointer rounded-2xl bg-purple-500 hover:bg-purple-400 text-white" variant={"outline"}>
            + Add
          </Button>
        </div>
